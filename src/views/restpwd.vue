...
密码不少于6位，至少包含字母/数字/符号2种组合。</span>
        ...
        <div v-if="steps == '5'" class="step-5-wrap" style="">
            ...
            <div class="item">
                ...
                <button @click="ajaxcode" class="codebtn" :disabled="btntext != '重新发送'" :style="{backgroundColor:btntext != '重新发送' ? '#CCC' :'#FFB0B0'}">
                      {{btntext}}
                 </button>
            </div>
        </div>
        ...
        <br>
        <button v-if="steps == '5'" style="width:150px" @click="save" class="savebtn">保存并重新登陆</button>
        <br>
